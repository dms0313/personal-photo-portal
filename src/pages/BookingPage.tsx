            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <motion.div
                            layout
                            className={`bg-white/85 backdrop-blur-md rounded-2xl border border-black/10 p-6 h-full shadow-lg shadow-black/5 ${!selectedDate ? 'opacity-50 pointer-events-none grayscale' : ''}`}
                        >
                            {!isSubmitted ? (
