                    ...
                    <div className="flex flex-col gap-6">
                        {!isAuthenticated ? (
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                ...
                                {loginError && <p className="text-sm text-rose-600 text-center">{loginError}</p>}
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className={`grid grid-cols-1 gap-6 lg:grid-cols-3 ${managementDisabled ? 'opacity-50 pointer-events-none' : ''}`}>
                                <div className="col-span-2 space-y-4 rounded-2xl border border-black/10 bg-white p-6 shadow-lg shadow-black/5">
