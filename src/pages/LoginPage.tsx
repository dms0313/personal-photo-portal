...
export function LoginPage() {
    ...
    return (
        <div className="min-h-screen text-[#EEEEEE] flex flex-col">
            <div className={`mx-auto flex w-full max-w-5xl flex-col gap-10 px-6 ${isAuthenticated ? 'py-24 md:py-32' : 'flex-grow justify-center items-center'}`}>
                <div className="space-y-3 text-center">
                    <p className="text-sm uppercase tracking-[0.3em] text-[#EEEEEE]/70 intro-fade-up intro-delay-1">Owner Access</p>
                ...
                <motion.div
                    ...
                    className="w-full max-w-md mx-auto rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-[#00ADB5]/10 backdrop-blur intro-glow"
                >
                    <div className="flex flex-col gap-6">
                        {!isAuthenticated ? (
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                <label className="block space-y-2 text-sm font-medium text-[#EEEEEE]/80">
                                    <input
                                        type="password"
                                        className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 text-center tracking-widest"
                                ...
                                <button
                                    type="submit"
                                    className="w-full rounded-xl bg-gradient-to-r from-[#00ADB5] to-[#EEEEEE] px-6 py-3 text-sm font-semibold uppercase tracking-wide text-[#303841] shadow-lg shadow-[#00ADB5]/25 transition hover:from-[#00ADB5]/90 hover:to-[#EEEEEE]/90 focus:outline-none focus:ring-2 focus:ring-[#00ADB5]/50"
                                >
                                    Unlock
                                </button>
                            </form>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between gap-4">
                                    <div>
                                        <p className="text-sm font-medium text-[#EEEEEE]/80">Signed in as</p>
                                        <p className="text-lg font-semibold text-[#EEEEEE]">{ownerEmail}</p>
                                    </div>
                                ...
                                <button
                                    type="button"
                                    onClick={logout}
                                    className="w-full rounded-xl border border-white/10 px-6 py-3 text-sm font-semibold uppercase tracking-wide text-[#EEEEEE]/80 transition hover:border-white/30 hover:text-[#EEEEEE] focus:outline-none focus:ring-2 focus:ring-white/30"
                                >
                                    Log out
                                </button>
                            </div>
                ...
                {isAuthenticated && (
                    <>
                        <motion.div
                            ...
                            className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 text-sm text-[#EEEEEE]/70"
                        >
                            <h2 className="mb-2 text-sm font-semibold text-[#EEEEEE]">How this works</h2>
                        ...
                        <motion.section
                            ...
                            className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-[#00ADB5]/10 backdrop-blur space-y-6"
                        >
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center justify-between">
                                    <p className="text-sm uppercase tracking-[0.3em] text-[#EEEEEE]/70">Content management</p>
                            ...
                            <div className={`grid grid-cols-1 gap-6 lg:grid-cols-3 ${managementDisabled ? 'opacity-50 pointer-events-none' : ''}`}>
                                <div className="col-span-2 space-y-4 rounded-2xl border border-white/10 bg-black/40 p-6">
                                    ...
                                    <div className="flex gap-2 p-1 rounded-xl bg-white/5">
                                        <button
                                            ...
                                            className={`flex-1 px-4 py-2 rounded-lg text-sm font-medium transition ${uploadMode === 'file'
                                                ? 'bg-gradient-to-r from-[#00ADB5] to-[#EEEEEE] text-[#303841] shadow-lg'
                                                : 'text-[#EEEEEE]/70 hover:text-[#EEEEEE]'
                                                }`}
                                        >
                                            📁 Upload File
                                        </button>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <label className="space-y-2 text-sm font-medium text-[#EEEEEE]/80">
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30"
                                            />
                                        </label>
                                        <label className="space-y-2 text-sm font-medium text-[#EEEEEE]/80">
                                            <span>Category</span>
                                            <select
                                                ...
                                                className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 appearance-none"
                                            >
                                        ...
                                        <label className="space-y-2 text-sm font-medium text-[#EEEEEE]/80 md:col-span-2">
                                    ...
                                    {uploadMode === 'url' ? (
                                        <div className="space-y-4">
                                            <div className="rounded-xl border border-[#00ADB5]/30 bg-[#00ADB5]/10 px-4 py-3 text-sm text-[#EEEEEE]/80">
                                            ...
                                            {imageUrl && (
                                                <div className="rounded-xl border border-white/10 bg-black/40 p-4">
                                                    <p className="text-sm text-[#EEEEEE]/80 mb-2">Preview</p>
                                                    <img
                                                        src={imageUrl}
                                                        alt="Preview"
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <label className="space-y-2 text-sm font-medium text-[#EEEEEE]/80">
                                                ...
                                                <textarea
                                                    ...
                                                    rows={8}
                                                    className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 font-mono text-sm"
                                                />
                                            </label>
                                            {bulkUrls && (
                                        ...
                                        <div className="space-y-4">
                                            <div className="space-y-2 text-sm font-medium text-[#EEEEEE]/80">
                                                ...
                                                <label className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-white/20 bg-black/30 px-6 py-8 text-center transition hover:border-white/40 cursor-pointer">
                                                    ...
                                                    <div className="flex flex-col items-center gap-2 text-[#EEEEEE]/80">
                                                        <span className="text-lg font-semibold">Drop an image or click to browse</span>
                                                        <span className="text-xs text-[#EEEEEE]/70">High-resolution JPG or PNG recommended</span>
                                                    </div>
                                                    {selectedFile && <p className="text-xs text-[#EEEEEE]/80">{selectedFile.name}</p>}
                                                </label>
                                            </div>

                                            {previewUrl && (
                                                <div className="rounded-xl border border-white/10 bg-black/40 p-4">
                                                    <p className="text-sm text-[#EEEEEE]/80">Preview</p>
                                    ...
                                    {uploadStatus && <p className="text-sm text-[#EEEEEE]/80">{uploadStatus}</p>}

                                    <button
                                        type="button"
                                        onClick={uploadMode === 'bulk' ? handleBulkImport : uploadMode === 'url' ? handleAddFromUrl : handleUpload}
                                        disabled={isUploading}
                                        className="w-full rounded-xl bg-gradient-to-r from-[#00ADB5] to-[#EEEEEE] px-6 py-3 text-sm font-semibold uppercase tracking-wide text-[#303841] shadow-lg shadow-[#00ADB5]/25 transition hover:from-[#00ADB5]/90 hover:to-[#EEEEEE]/90 focus:outline-none focus:ring-2 focus:ring-[#00ADB5]/50 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                            ...
                                            <div key={photo.id} className="rounded-xl border border-white/5 bg-white/5 p-4 space-y-3">
                                                    ...
                                                    <div className="flex flex-col gap-2 flex-1 min-w-0">
                                                        <div className="flex flex-col sm:flex-row gap-2">
                                                            <input
                                                                ...
                                                                className="flex-1 rounded-lg border border-white/10 bg-black/40 px-3 py-2 text-sm text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 w-full"
                                                            />
                                                            <select
                                                                value={drafts[photo.id]?.category ?? photo.category}
                                                                onChange={(event) => handleDraftChange(photo.id, 'category', event.target.value)}
                                                                className="w-full sm:w-32 rounded-lg border border-white/10 bg-black/40 px-2 py-2 text-sm text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 appearance-none"
                                                            >
                                                                <option value="people">People</option>
                                                                <option value="landscape">Landscape</option>
                                                                <option value="events">Events</option>
                                                        ...
                                                        <input
                                                            ...
                                                            className="rounded-lg border border-white/10 bg-black/40 px-3 py-2 text-sm text-[#EEEEEE] outline-none transition focus:border-[#00ADB5] focus:ring-2 focus:ring-[#00ADB5]/30 w-full"
                                                        />
                                                    </div>
                                                </div>
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex-[2] rounded-lg border border-[#00ADB5]/40 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-[#EEEEEE]/80 transition hover:border-[#00ADB5] hover:text-[#EEEEEE]"
                                                    >
                                                        Save updates
                                                    </button>
                                                </div>
